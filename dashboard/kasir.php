...
<body>
    ...
    <section id="input-transaksi" class="container py-5 bg-white rounded-4 shadow-sm my-5 p-4">
        ...
        <form action="../transaksi/transaksi.php" method="POST">
            ...
            <!-- button simpan dan kurangin stok (merah) -->
